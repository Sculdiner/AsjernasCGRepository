...
Shader "Shadero Customs/CardHighlightAdvancedShader"
{
Properties
{
...
KaleidoscopeUV_Number_1("KaleidoscopeUV_Number_1", Range(0, 6)) = 1.95
_Generate_Fire_PosX_1("_Generate_Fire_PosX_1", Range(-1, 2)) = 0.313
_Generate_Fire_PosY_1("_Generate_Fire_PosY_1", Range(-1, 2)) = 0.125
_Generate_Fire_Precision_1("_Generate_Fire_Precision_1", Range(0, 1)) = 0.475
_Generate_Fire_Smooth_1("_Generate_Fire_Smooth_1", Range(0, 1)) = 0.538
_Generate_Fire_Speed_1("_Generate_Fire_Speed_1", Range(-2, 2)) = 0.314
_CircleFade_PosX_1("_CircleFade_PosX_1", Range(-1, 2)) = 0.5
_CircleFade_PosY_1("_CircleFade_PosY_1", Range(-1, 2)) = 0.5
_CircleFade_Size_1("_CircleFade_Size_1", Range(-1, 1)) = 0.354
_CircleFade_Dist_1("_CircleFade_Dist_1", Range(0, 1)) = 0.077
_FillColor_Color_1("_FillColor_Color_1", COLOR) = (0.5613208,1,0.8296105,1)
_SourceNewTex_1("_SourceNewTex_1(RGB)", 2D) = "white" { }
_ShadowLight_Precision_1("_ShadowLight_Precision_1", Range(1, 32)) = 18.9
_ShadowLight_Size_1("_ShadowLight_Size_1", Range(0, 16)) = 0.61
_ShadowLight_Color_1("_ShadowLight_Color_1", COLOR) = (0.4588235,1,0.4470588,1)
_ShadowLight_Intensity_1("_ShadowLight_Intensity_1", Range(0, 4)) = 2.179
...
_Add_Fade_1("_Add_Fade_1", Range(0, 4)) = 0.829
...
float4 FillColor_1 = UniColor(_CircleFade_1,_FillColor_Color_1);
...
FillColor_1 = lerp(FillColor_1,FillColor_1*FillColor_1.a + _ShadowLight_1*_ShadowLight_1.a,_Add_Fade_1 * _ShadowLight_1.a);
